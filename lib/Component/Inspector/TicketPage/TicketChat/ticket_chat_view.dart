...
//           ),
//           Obx(() {
//             return controller.uploadedImagePaths.isNotEmpty
//                 ? Container(
//               height: 100.h,
...
//                             image: FileImage(File(controller.uploadedImagePaths[index])),
//                             fit: BoxFit.cover,
//                           ),
//                         ),
//                       ),
...
//                 children: [
//                   IconButton(
//                     icon: Icon(Icons.add_photo_alternate, color: Colors.grey.shade700, size: 24.sp),
...
//                       _buildImageAttachments(attachments, isMyMessage, controller),
//                     ],
//                     Padding(
...
//   }
//
//   Widget _buildImageThumbnail(String imageUrl, List<String> allImageUrls, int index, TicketChatController controller, {required double width, required double height}) {
//     return GestureDetector(
//       onTap: () {
//         controller.openImageFullScreen(imageUrl, allImageUrls, index);
//       },
//       child: Container(
