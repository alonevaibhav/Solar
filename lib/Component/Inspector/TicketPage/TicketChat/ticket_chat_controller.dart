...
//     if (message.isEmpty && uploadedImagePaths.isEmpty) return;
//
//     try {
...
//         "ticket_status": "open",
//         "sender_name": "John Doe",
//         "attachments": uploadedImagePaths.map((path) => {
//           "path": path,
//         }).toList(),
//       };
//
...
class TicketChatController extends GetxController {
  ...
  List<Map<String, dynamic>> mockMessages = [
    ...
    },
    {
      ...
      "time": "17:15:14",
      "sender_id": 8,
      "msg": "The system is not responding properly when I try to submit the form. Here are some screenshots and a video:",
      "created_at": "2025-06-11T11:45:14.000Z",
      "updatedAt": "2025-06-11T11:45:14.000Z",
      "sender_type": "inspector",
      "ip": "::ffff:127.0.0.1",
  ...
  List<Map<String, dynamic>> getImageAttachments(List<Map<String, dynamic>> attachments) {
    return attachments.where((attachment) =>
    attachment['type'] == 'image' || attachment['type'] == null
    ).toList();
  }

  List<Map<String, dynamic>> getVideoAttachments(List<Map<String, dynamic>> attachments) {
    return attachments.where((attachment) =>
